...
public class GameSettings : ISingletonScript
{
    ...
    public LevelInfo CurrentLevel
    {
        get
        {
            return levels[UnityEngine.SceneManagement.SceneManager.GetActiveScene().buildIndex];
        }
    }
    ...
    public LevelInfo NextLevel
    {
        get
        {
            ...
            if ((UnityEngine.SceneManagement.SceneManager.GetActiveScene().buildIndex + 1) < NumLevels)
            {
                returnLevel = levels[(UnityEngine.SceneManagement.SceneManager.GetActiveScene().buildIndex + 1)];
            }
            return returnLevel;
        }
    }
